/* 
Sean Diaz - HW3 - Wenjin Zhou GUI PROGRAMMING 
6/3/24
sean_diaz@student.uml.edu

What I learned!
Wow! This assignment was challenging for me. I havent touched javascript in over a year, and even then It was trivial. 
I basically used the entire week doing the assignment everyday. SO...MANY...BUGS. But in return, I learned so much. 
Firstly...I learned how to get elements by their ID's
What callback functions are...
how tables work and more in depth from assignment one...

how to get a value in a box in a form...
and so much more. event listeners...etc...
The interactions between the html, css and JS are awesome. 

Some troubles...
Where do I begin...I lost about a day of progress trying to understand how to allign the numbers, I tried skipping a spot, which messed everything up for some reason
until it occured to me to draw out the table. I noticed in the grid, I could just make an empty header cell and add it to the beginning. 

Overall really challenging but I think I've done everything the assignment has asked of me!
~Sean
Where I got some info from besides W3 Schools!
